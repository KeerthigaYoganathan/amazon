          ...
          <div className="filter-box">
            ...
            <div className="filter-pricing">
              ...
              <div className="d-flex flex-column">
                <div className="filter-pricing-min">
                  <input
                    type="radio"
                    id="filter-pricing-min"
                    name="filter-price"
                    value="min"
                    onChange={(event) => {
                      handleInpChg(event);
                ...
                <div className="filter-pricing-max">
                  <input
                    type="radio"
                    id="filter-pricing-max"
                    name="filter-price"
                    value="max"
                    onChange={(event) => {
                      handleInpChg(event);
            ...
            <div className="filter-best-selling">
              ...
              <input
                type="checkbox"
                id="best-selling"
                name="filter-best-selling"
                value="filter-pricing-max"
                onChange={(event) => {
                  handleInpChg(event);
                }}
              />
