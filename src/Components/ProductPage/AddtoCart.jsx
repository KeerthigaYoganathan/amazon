          ...
          {details?.map((item, index)=>{
            ...
            return(
              <div className='add-to-cart-delivery'>
                ...
                <p style={{fontSize:"22px", fontWeight:600}}><sup style={{fontSize:"12px"}} key={item?.id}>$</sup>{item?.buyingPrice}</p>
                <p style={{marginTop:"12px", fontSize:"15px"}}><span style={{color: "#007185"}}>FREE delivery</span> <b>{dateFormatFn(item.freeDeliveryDate)}.</b><span style={{color: "#007185"}}>Details</span></p>
                <p style={{marginTop:"12px", fontSize:"15px"}}>Or fastest delivery <b>{dateFormatFn(item.fastDeliveryDate)}.</b> Order within <span style={{color: "#007600"}}>5 hrs 37 mins.</span> <span style={{color: "#007185"}}>Details</span></p>
                <p style={{marginTop:"12px", fontSize:"12px", color: "#007185"}}><i class="bi bi-geo-alt"></i>Delivering to London N6J – Update location</p>
                <p style={{fontSize:"22px", fontWeight:500, color: "#007600", marginTop:"7px"}}>In Stock</p>
                <div className="d-flex justify-content-between" style={{background:"#F0F2F2", border:"1px solid rgb(209, 204, 204)", borderRadius:"4px", padding:"4px", marginTop:"8px"}}><p>Quantity: 1</p> <i className="bi bi-chevron-down"></i></div>
